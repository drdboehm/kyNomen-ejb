...
- mavenproject1-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- mavenproject1-ui: main application module, development time
- mavenproject1-production: module that produces a production mode WAR for deployment
